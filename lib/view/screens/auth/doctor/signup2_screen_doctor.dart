...
class SingUpDoctorPage extends StatefulWidget {
  const SingUpDoctorPage({Key? key}) : super(key: key);

  @override
  State<SingUpDoctorPage> createState() => _SignUpScreenState();
}

class _SignUpScreenState extends State<SingUpDoctorPage> {
